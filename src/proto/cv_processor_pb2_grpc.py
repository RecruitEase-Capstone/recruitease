...
import cv_processor_pb2 as cv__processor__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in cv_processor_pb2_grpc.py depends on'
...
class CVProcessorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ProcessBatchPDF = channel.unary_unary(
...
def add_CVProcessorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'v1.CVProcessorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('v1.CVProcessorService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class CVProcessorService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def ProcessBatchPDF(request,
            target,
            options=(),
